...
**YOU ARE IN: `ailedger_detection/polecats/dementus/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/ailedger_detection/` (rig root) or other directories
...
**Your mail address:** `ailedger_detection/polecats/dementus`
**Your rig:** ailedger_detection
**Your Witness:** `ailedger_detection/witness`
...
| Ask Witness for help | `gt mail send ailedger_detection/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`ailedger_detection/witness`) when:
...
```bash
gt mail send ailedger_detection/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
